...
const operationPhase: JobCardProps[] = [
  {
    ...
    iconSrc: "/pm/pm-icon9.jpg",
    onHoverIconSrc: "/pm/pm-icon9-1.jpg",
  },
  {
    title: "CƯ DÂN/\nKHÁCH THUÊ",
    description: [
    ...
    iconSrc: "/pm/pm-icon10.jpg",
    onHoverIconSrc: "/pm/pm-icon10-1.jpg",
  },
  {
    title: "BẢO TRÌ\nBẢO DƯỠNG",
    description: [
    ...
    iconSrc: "/pm/pm-icon11.jpg",
    onHoverIconSrc: "/pm/pm-icon11-1.jpg",
  },
  {
    title: "QUẢN LÝ\nTÀI CHÍNH",
    description: ["Quản lý và kiểm soát các vấn đề liên quan đến tài chính"],
    iconSrc: "/pm/pm-icon12.jpg",
    onHoverIconSrc: "/pm/pm-icon12-1.jpg",
  },
  {
    title: "QUẢN LÝ\nNHÀ THẦU DỊCH VỤ",
    description: [
    ...
    iconSrc: "/pm/pm-icon13.jpg",
    onHoverIconSrc: "/pm/pm-icon13-1.jpg",
  },
  {
    title: "AN TOÀN\nLAO ĐỘNG",
    description: [
    ...
    iconSrc: "/pm/pm-icon14.jpg",
    onHoverIconSrc: "/pm/pm-icon14-1.jpg",
  },
  {
    title: "BÁO CÁO",
    description: [
    ...
    iconSrc: "/pm/pm-icon15.jpg",
    onHoverIconSrc: "/pm/pm-icon15-1.jpg",
  },
  {
    title: "QUẢN LÝ TIỆN ÍCH",
    description: [
